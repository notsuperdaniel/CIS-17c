...
void Player::inFile(int &fileCnt){
    ...
    if (fileCnt==1){
         ...
         dataFile<<"Game 1:"<<endl;                             //Formatting (12.2)
        ...
        dataFile<<"Your score"<<setw(7)<<"= "<<sum<<endl;       //Formatting (12.2)
        dataFile<<"Dealer's score"<<" = "<<dSum<<endl;
        dataFile<<"Result"<<setw(11)<<"= "<<result<<endl;
    }
    fileCnt++;
...
//==============================================================================
void Player::winLoss(){
    char ask[]= "Would you like to play again?";        //C-STRING (10.3)
    string prompt= "Enter (Y) for YES, enter (N) for NO."; //STRING (10.7)
  ...
  result="Lose";
    ...
    for (int i=0;i<strlen(ask);i++){                //C-STRING (10.3)
        cout<<ask[i];
    }
    do{
    cout<<endl<<prompt<<endl;
    //cout<<endl<<"Enter (1) for YES, enter Any Other Key for NO."<<endl;
    cin>>choice;
...
//Copy Constructor
//==============================================================================
Player::Player(Player& obj){        //COPY CONSTRUCTOR (14.4)
    users=obj.users;
    cards=obj.cards;
    bet=obj.bet;
    name=obj.name;
